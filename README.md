...
#### 自动编译2种架构插件及依赖：[![Workflow Status](https://github.com/zijieKwok/JacKwok-passwall/actions/workflows/build2.yml/badge.svg)](https://github.com/zijieKwok/JacKwok-passwall/actions)
